    ...
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} style={{ overflow: "visible" }}>
      <defs>
        <radialGradient id="ssg" cx="35%" cy="30%" r="65%">
          ...
          <stop offset="55%" stopColor="rgba(37,99,235,0.5)" />
          <stop offset="100%" stopColor="rgba(15,30,55,0)" />
        </radialGradient>
      ...
      <motion.ellipse cx={cx} cy={cy} rx={100} ry={28} fill="none" stroke="rgba(37,99,235,0.6)" strokeWidth="1.2" filter="url(#ssRingGlow)"
